...
## 概要 Summary
 ...
 Note that the communication between the two are made in HTTP, and the application by itself doesn't support encryption; if you send the data over HTTP instead of HTTPS, you are vulnerable to eavesdropping the man in the middle attack.
